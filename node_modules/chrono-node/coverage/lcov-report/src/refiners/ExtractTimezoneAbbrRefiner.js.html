...
<html lang="en">
<head>
    <title>Code coverage report for src/refiners/ExtractTimezoneAbbrRefiner.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/refiners/ExtractTimezoneAbbrRefiner.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/refiners/</a> &#187; ExtractTimezoneAbbrRefiner.js</div>
</div>
<div class="body">
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (result.end != null &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!result.end.isCertain('timezoneOffset'))</span> {
